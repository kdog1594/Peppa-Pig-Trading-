...
def Strategy(prices):
    ...
    for pair in pairs:
        ...
        #Using Last 40 days to generate rolling spread statistics.
        ...
        if z_score >= 2.5: 
            ...
            #if we myPositions[previous] > myPositions[new]
            #myPositions[new] = myPositions[previous] + myPositions[new]
